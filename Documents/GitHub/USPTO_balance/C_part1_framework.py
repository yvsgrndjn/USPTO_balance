...
def main(GDB13S_path, df_templates_path_to_pkl, GDB_version, template_version):
    ...
    for retro_reac in unique_retro_reac_values:
        GDB13S_sub, match_ind = extract_match_smiles_from_dataset(GDB13S, GDB13S_mol, retro_reac)
        convert_and_save_subset(GDB13S_sub, GDB13S_mol, retro_reac, GDB_version, template_version)
